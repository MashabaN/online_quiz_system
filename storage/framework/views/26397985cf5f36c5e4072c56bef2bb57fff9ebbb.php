...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo e(url('assets/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTELogo" height="60" width="60">
  </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="<?php echo e(url('admin/exam_category')); ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo e(url('admin/manage_exam')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Exam</p>
              </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('admin/manage_students')); ?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Students</p>
            </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo e(url('admin/registered_students')); ?>" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
...
<?php /**PATH D:\xaamp\htdocs\laravel-quiz-application\themes\dashboard\views/layouts/app.blade.php ENDPATH**/ ?>